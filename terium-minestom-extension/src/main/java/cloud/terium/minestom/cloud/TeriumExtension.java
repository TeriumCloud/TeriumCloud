...
import cloud.terium.minestom.cloud.impl.config.ConfigManager;
import cloud.terium.minestom.cloud.impl.console.CommandFactory;
import cloud.terium.minestom.cloud.impl.console.ConsoleProvider;
import cloud.terium.minestom.cloud.impl.entity.CloudPlayerProvider;
import cloud.terium.minestom.cloud.impl.event.EventProvider;
import cloud.terium.minestom.cloud.impl.module.ModuleProvider;
import cloud.terium.minestom.cloud.impl.node.NodeProvider;
import cloud.terium.minestom.cloud.impl.pipe.TeriumNetworking;
import cloud.terium.minestom.cloud.impl.service.ServiceFactory;
import cloud.terium.minestom.cloud.impl.service.ServiceProvider;
import cloud.terium.minestom.cloud.impl.service.group.ServiceGroupFactory;
import cloud.terium.minestom.cloud.impl.service.group.ServiceGroupProvider;
import cloud.terium.minestom.cloud.impl.template.TemplateFactory;
import cloud.terium.minestom.cloud.impl.template.TemplateProvider;
...
@Getter
public final class TeriumExtension extends TeriumAPI {
    ...
    public static TeriumExtension getInstance() {
        return instance;
    }
