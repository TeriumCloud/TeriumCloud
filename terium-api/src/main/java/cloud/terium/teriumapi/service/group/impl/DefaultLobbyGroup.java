...
public class DefaultLobbyGroup {

    /*
     * Make all DefaultGroups implement ICloudServiceGroup
     * Also implement terium-api in terium-cloud and terium-bridge
     */
    ...
    public DefaultLobbyGroup(String name, String groupTitle, String node, boolean maintenance, int maximumPlayers, int memory, int minimalServices, int maximalServices) {
        ...
        try (final PrintWriter writer = new PrintWriter("groups/" + CloudServiceType.Lobby + "/" + name + ".json")) {
