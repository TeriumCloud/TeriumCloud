...
@Module(name = "hubcommand", author = "veteex", version = "1.7-OXYGEN", description = "", reloadable = false, moduleType = ModuleType.Proxy)
public class TeriumHubCommandModule implements IModule {
