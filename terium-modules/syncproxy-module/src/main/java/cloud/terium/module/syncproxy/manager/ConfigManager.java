...
public class ConfigManager {
    ...
    private void initFile() {
        ...
        if (!file.exists()) {
            ...
            json.addProperty("tablist_header", "\n <gradient:#245dec:#00d4ff>Terium</gradient> <dark_gray>⇨ <white>a modern cloudsystem <gray>[<white>1.6-OXYGEN<gray>] \n <white>You're connected with <#e2adf7>%server% \n");
            ...
            json.addProperty("motd.line1", "<gradient:#245dec:#00d4ff>Terium</gradient> <dark_gray>⇨ <white>a modern cloudsystem <gray>[<white>1.6-OXYGEN<gray>]");
            json.addProperty("motd.line2", "<gray>› <white>Terium by <#41dbfa>ByRaudy <white>and <#69e2fa>contributors <red>❤");
            json.addProperty("motd.maintenance.line1", "<gradient:#245dec:#00d4ff>Terium</gradient> <dark_gray>⇨ <white>a modern cloudsystem <gray>[<white>1.6-OXYGEN<gray>]");
