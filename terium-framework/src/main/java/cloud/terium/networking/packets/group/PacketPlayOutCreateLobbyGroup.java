...
@Getter
public class PacketPlayOutCreateLobbyGroup extends Packet {
    ...
    public PacketPlayOutCreateLobbyGroup(String name, String groupTitle, String node, ITemplate template, String version, boolean maintenance, int maximumPlayers, int memory, int minimalServices, int maximalServices) {
        this.name = name;
    ...
    public PacketPlayOutCreateLobbyGroup(ByteBuf byteBuf) {
